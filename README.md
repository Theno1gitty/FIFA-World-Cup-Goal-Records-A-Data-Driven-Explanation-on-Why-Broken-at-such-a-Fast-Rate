...
## How to Run
```bash
git clone [https://github.com/Theno1gitty/FIFA-World-Cup-Goal-Records-A-Data-Driven-Explanation-on-Why-Broken-at-such-a-Fast-Rate.git](https://github.com/Theno1gitty/FIFA-World-Cup-Goal-Records-A-Data-Driven-Explanation-on-Why-Broken-at-such-a-Fast-Rate.git)
python main.py
